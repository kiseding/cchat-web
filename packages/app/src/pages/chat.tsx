    ...
    <div class="h-full flex flex-col max-w-4xl mx-auto">
      ...
      >
        ...
        <div class="flex justify-between mt-2">
          <span class="text-xs" style={{ color: permissionMode() === "bypassPermissions" ? "#ff6b91" : "var(--text-weak)" }}>
          ...
          <span class="text-xs" style="color: var(--text-weak)">Enter ↵ · Shift+Enter ↵↵</span>
        </div>
      </div>
