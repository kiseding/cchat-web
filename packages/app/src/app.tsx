  ...
  return (
    <div class="h-dvh w-screen flex items-center justify-center relative" style="background: var(--bg-base)">
      ...
      <div class="absolute bottom-4 left-0 right-0 flex items-center justify-between px-6">
        ...
        <a href="https://github.com/kiseding" target="_blank" class="text-[13px] cursor-pointer opacity-40 hover:opacity-70 transition-opacity no-underline" style="color: var(--text-weak)">
          Design by kiseding
        </a>
      </div>
    </div>
